...
class TestWatchAutoDiscovery:
    def test_watch_no_arg_no_claude_md_exits_nonzero(self, tmp_path: Path) -> None:
    ...
    def test_watch_no_arg_error_mentions_claude_md(self, tmp_path: Path) -> None:
    ...
    def test_watch_discovers_claude_md_and_recompresses(self, tmp_path: Path) -> None:
...
class TestAuditKeywordHint:
    def test_audit_shows_mutable_keyword_that_triggered(self, tmp_path: Path) -> None:
    ...
    def test_audit_shows_immutable_keyword_that_triggered(self, tmp_path: Path) -> None:
    ...
    def test_audit_annotation_source_shows_annotation_not_keyword(self, tmp_path: Path) -> None:
    ...
    def test_audit_structural_heuristic_shows_structural_hint(self, tmp_path: Path) -> None:
    ...
    def test_audit_no_keyword_falls_back_gracefully(self, tmp_path: Path) -> None:
    ...
    def test_audit_extra_immutable_keyword_from_config_shown(self, tmp_path: Path) -> None:
